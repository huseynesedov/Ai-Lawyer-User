                ...
                <div className="row">
                    <div className="col-xl-12">
                        <div className="Bloq-Details-hero">
                            <img
                                src={images.bloqcard1}
                                alt="Background"
                                className="bloq-details-img"
                            />
                            <div className="bloq-details-content">
                                <div className="col-xl-6">
                                    <h2 className="bloq-details-text">Tövsiyyə məktubu haqqında bilməli olduğunuz hərşey</h2>
                                </div>
                        ...
                        <div className="Bloq-Details-main">
                            <ol>
                                <h4><li>1. Tövsiyyə Məktubu Haqqında Bilməli Olduğunuz Hər Şey</li></h4>
                                <li>1. Tövsiyyə Məktubu Haqqında Bilməli Olduğunuz Hər Şey <br />Giriş <br />
