...
function Chat() {
    ...
    const chatId = 0; // Default chatId, you will set this dynamically based on selected chat
    ...
    const handleChatClick = async (chatId) => {
        try {
            ...
            console.log('Fetched messages for chat ID:', chatId);
            console.log(response);
            
            if (response && response.messages) {
                console.log('Messages for the chat:', response.messages);
            } else {
                ...
                <div className="col-3" style={{ height: "671px" }}>
                    <div className="leftbar h-100 d-flex flex-column justify-content-between bg-turkuaz">
                        <div>
                            ...
                            <div className="d-flex bg-turkuaz flex-column justify-content-between mt-5">
                                <div className='mt-4'>
                                    <div>

                                    <button className='Chat-button d-flex align-items-center justify-content-between'>
                                           Yeni Chat
                                            <img
